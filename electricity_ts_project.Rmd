...
Now that we know that ARMA(5, 6) minimizes the AIC criterion, we will use those values to fit an ARMA model to our residuals.
```{r}
...
```{r}
Yt <- zt_2023$pred + m_t[145:156] + s_t[145:156]
Yt
